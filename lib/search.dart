                  ...
                  return Stack(
                    children: [
                          ...
                          Container(
                            ...
                            child: Image(
                               fit:BoxFit.fill,
                               image: NetworkImage((data["articles"][index]["urlToImage"]==null)?"https://media.istockphoto.com/id/1194173085/vector/news-11.jpg?s=612x612&w=0&k=20&c=KMYRAgrCfDnr3x0oP1j5czEaXDCTVrx60bIpxxwy9yc=":"${data["articles"][index]["urlToImage"]}")),
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                         // data["articles"][index]["publishedAt"].toString().replaceRange(data["articles"][index]["publishedAt"].lenght-4, data["articles"][index]["publishedAt"].length, ""),
                                           data["articles"][index]["publishedAt"].toString().replaceRange(data["articles"][index]["publishedAt"].length-4, data["articles"][index]["publishedAt"].length, ""),
                                        style: TextStyle(
                                            fontSize: 17,
                                            fontFamily: "Nunito",
                                            color: Colors.white,
